...
public final class ProductInfoGrpc {
  ...
  public static final String SERVICE_NAME = "protobuf.com.jie.api.ProductInfo";

  // Static method descriptors that strictly reflect the proto.
  private static volatile io.grpc.MethodDescriptor<protobuf.com.jie.api.Product,
      protobuf.com.jie.api.ProductID> getAddProductMethod;

  @io.grpc.stub.annotations.RpcMethod(
      fullMethodName = SERVICE_NAME + '/' + "addProduct",
      requestType = protobuf.com.jie.api.Product.class,
      responseType = protobuf.com.jie.api.ProductID.class,
      methodType = io.grpc.MethodDescriptor.MethodType.UNARY)
  public static io.grpc.MethodDescriptor<protobuf.com.jie.api.Product,
      protobuf.com.jie.api.ProductID> getAddProductMethod() {
    io.grpc.MethodDescriptor<protobuf.com.jie.api.Product, protobuf.com.jie.api.ProductID> getAddProductMethod;
      ...
      synchronized (ProductInfoGrpc.class) {
        if ((getAddProductMethod = ProductInfoGrpc.getAddProductMethod) == null) {
          ProductInfoGrpc.getAddProductMethod = getAddProductMethod =
              io.grpc.MethodDescriptor.<protobuf.com.jie.api.Product, protobuf.com.jie.api.ProductID>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.UNARY)
              .setFullMethodName(generateFullMethodName(SERVICE_NAME, "addProduct"))
              .setSampledToLocalTracing(true)
              .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  protobuf.com.jie.api.Product.getDefaultInstance()))
              .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  protobuf.com.jie.api.ProductID.getDefaultInstance()))
  ...
  private static volatile io.grpc.MethodDescriptor<protobuf.com.jie.api.ProductID,
      protobuf.com.jie.api.Product> getGetProductMethod;

  @io.grpc.stub.annotations.RpcMethod(
      fullMethodName = SERVICE_NAME + '/' + "getProduct",
      requestType = protobuf.com.jie.api.ProductID.class,
      responseType = protobuf.com.jie.api.Product.class,
      methodType = io.grpc.MethodDescriptor.MethodType.UNARY)
  public static io.grpc.MethodDescriptor<protobuf.com.jie.api.ProductID,
      protobuf.com.jie.api.Product> getGetProductMethod() {
    io.grpc.MethodDescriptor<protobuf.com.jie.api.ProductID, protobuf.com.jie.api.Product> getGetProductMethod;
    if ((getGetProductMethod = ProductInfoGrpc.getGetProductMethod) == null) {
      synchronized (ProductInfoGrpc.class) {
        if ((getGetProductMethod = ProductInfoGrpc.getGetProductMethod) == null) {
          ProductInfoGrpc.getGetProductMethod = getGetProductMethod =
              io.grpc.MethodDescriptor.<protobuf.com.jie.api.ProductID, protobuf.com.jie.api.Product>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.UNARY)
  ...
  public static abstract class ProductInfoImplBase implements io.grpc.BindableService {
    ...
    /**
     */
    public void addProduct(protobuf.com.jie.api.Product request,
        io.grpc.stub.StreamObserver<protobuf.com.jie.api.ProductID> responseObserver) {
      io.grpc.stub.ServerCalls.asyncUnimplementedUnaryCall(getAddProductMethod(), responseObserver);
    }

    /**
     */
    public void getProduct(protobuf.com.jie.api.ProductID request,
        io.grpc.stub.StreamObserver<protobuf.com.jie.api.Product> responseObserver) {
      ...
      return io.grpc.ServerServiceDefinition.builder(getServiceDescriptor())
          .addMethod(
            ...
            io.grpc.stub.ServerCalls.asyncUnaryCall(
              new MethodHandlers<
                protobuf.com.jie.api.Product,
                protobuf.com.jie.api.ProductID>(
  ...
  public static final class ProductInfoBlockingStub extends io.grpc.stub.AbstractBlockingStub<ProductInfoBlockingStub> {
    ...
    /**
     */
    public protobuf.com.jie.api.ProductID addProduct(protobuf.com.jie.api.Product request) {
    ...
    /**
     */
    public protobuf.com.jie.api.Product getProduct(protobuf.com.jie.api.ProductID request) {
      return io.grpc.stub.ClientCalls.blockingUnaryCall(
  ...
  public static final class ProductInfoFutureStub extends io.grpc.stub.AbstractFutureStub<ProductInfoFutureStub> {
    ...
    /**
     */
    public com.google.common.util.concurrent.ListenableFuture<protobuf.com.jie.api.ProductID> addProduct(
        protobuf.com.jie.api.Product request) {
    ...
    /**
     */
    public com.google.common.util.concurrent.ListenableFuture<protobuf.com.jie.api.Product> getProduct(
        protobuf.com.jie.api.ProductID request) {
      return io.grpc.stub.ClientCalls.futureUnaryCall(
    ...
    public void invoke(Req request, io.grpc.stub.StreamObserver<Resp> responseObserver) {
      switch (methodId) {
        case METHODID_ADD_PRODUCT:
          serviceImpl.addProduct((protobuf.com.jie.api.Product) request,
              (io.grpc.stub.StreamObserver<protobuf.com.jie.api.ProductID>) responseObserver);
          break;
        case METHODID_GET_PRODUCT:
          serviceImpl.getProduct((protobuf.com.jie.api.ProductID) request,
              (io.grpc.stub.StreamObserver<protobuf.com.jie.api.Product>) responseObserver);
          break;
        default:
  ...
  private static abstract class ProductInfoBaseDescriptorSupplier
    ...
    public com.google.protobuf.Descriptors.FileDescriptor getFileDescriptor() {
      return protobuf.com.jie.api.Productinfo.getDescriptor();
    }
